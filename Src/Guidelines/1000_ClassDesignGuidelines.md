...
### <a name="av1010"></a> Не скрывайте предупреждения компилятора с помощью ключевого слова new  (AV1010) ![](images/1.png)

Это предупреждение компилятора [CS0114](https://docs.microsoft.com/en-us/dotnet/csharp/misc/cs0114) появляется в случае нарушения  [полиформизма](http://en.wikipedia.org/wiki/Polymorphism_in_object-oriented_programming) - одного из наиболее значимых принципов объектно-ориентированного программирования.
...
Предупреждение исчезает при добавлении ключевого слова `new`. При этом дочерние классы становятся ложными для понимания. Рассмотрим следующий пример: 
...
### <a name="av1026"></a> Классы должны поддерживать свое внутренние состояние непротеворечивым (AV1026) ![](images/1.png)
